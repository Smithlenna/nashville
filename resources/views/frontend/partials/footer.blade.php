					...
					<div class="bottom-footer">
						<div class="row d-flex align-items-center">
							...
							<div class="col-md-4 col-lg-3">
								...
								<img src="{{ asset('frontend/images/logo-white.png') }}" width="210" height="50" alt="footer-logo">
							</div>
		...
		<script src="{{ asset('frontend/js/hero-request-form.js') }}"></script>
		<script src="{{ asset('frontend/js/hero-register-form.js') }}"></script>
		<script src="{{ asset('frontend/js/request-form.js') }}"></script>	
