               ...
               <div class="panel panel-custom" data-collapsed="0">
                 ...
                 <div class="panel-body">
                     <div class="card-block">
                        ...
                        <input type="submit" name="submit" value="Add New Test" class="btn btn-primary" id="submit" style="margin-bottom: 20px">
                      </div>
                 </div>
               </div>
             </div>
                              ...
                              @if($all_test)
                                  @foreach($all_test as $key => $testList)
                                      <tr id="{{ $testList->id }}">
                                          ...
                                          <td><a href="{{ route('test.edit', $testList->id) }}">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            success: function(response) {                      
                                var editUrl = '{{ route("test.edit", ":data") }}';
                                ...
                                html += "<td style='padding: 6px 9px;'><span><input class='toggle-event' type='checkbox' data-toggle='toggle'  data-on='Show' data-off='Hide' data-size='mini'></span></td>";
                                html += "<td style='padding: 6px 14px;'><a href='"+editUrl+"'><button type='button' value='"+response.id+"' class='btn btn-primary btn-xs mr-5'><i class='fa fa-pencil-square-o'></i></button></a> <button type='button' value='"+response.id+"' class='btn btn-danger btn-xs  lastDataDelete'><i class='fa fa-trash-o'></i></button></td>";
