                ...
                <table id="datatable_action" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="basic-col-reorder_info">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $postsLists->course_length }}</td>
                            <td>{{ $postsLists->status }}</td>
                            <td><a href="{{ $postsLists->image }}" class="iframe-btn">View Image</a></td>
                            <td>
                                <a href="{{ route('courses.edit', $postsLists->id) }}" class="btn btn-primary btn-xs pull-left">
                                    <i class="fa fa-pencil-square-o"></i>
                                </a>
                                <a class="pull-left" onclick="return confirm('Are you sure you want to delete this post?')">
                                    <form method="POST" action="{{ route('courses.destroy', $postsLists->id) }}" accept-charset="UTF-8">
