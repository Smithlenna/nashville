   ...
   <div class="col-sm-12 wrap-fpanel">
      <div class="panel panel-custom" data-collapsed="0">
         ...
         <div class="panel-body">
              @if(!empty($data))
              <form action="{{ route('courses.update') }}" class="form-horizontal" method="post">
          @else
                          ...
                          <div class="card">
                              <div class="card-block">
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" value="{{ @$data->title }}" name="title" id="name" placeholder="e.g course_placeholder_title">
                                          @if ($errors->has('title'))
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" value="{{ @$data->slug }}" id="slug" name="slug" placeholder="e.g course_placeholder_link">
                                          @if ($errors->has('slug'))
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                          <select class="form-control editor" name="status">
