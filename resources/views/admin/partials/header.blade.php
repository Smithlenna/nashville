...
<head>
    ...
    <link id="autoloaded-stylesheet" rel="stylesheet" href="/admin/css/bg-danger-dark.css">
                ...
                <div class="navbar-header">
                    <a href="#/" class="navbar-brand">
                        <div class="brand-logo">
                            <img style="width: 100%;max-height: 42px;" src="/uploads/logo_tranparent.png" alt="App Logo" class="img-responsive">
                        </div>
                        <div class="brand-logo-collapsed">
                            <img style="width: 100%;height: 48px;border-radius: 50px" src="/uploads/logo_tranparent.png" alt="App Logo" class="img-responsive">
                        </div>
                    </a>
                </div>
                <!-- END navbar header-->
                ...
                <div class="nav-wrapper">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown dropdown-list notifications">
                            ...
                            <!-- START Dropdown menu-->
                            <ul class="dropdown-menu animated zoomIn notifications-list" data-total-unread="0" style="width: 350px">
                                <li class="text-sm text-right" style="border-bottom: 1px solid rgb(238, 238, 238)">
                                    <a href="#" class="list-group-item" onclick="mark_all_as_read(); return false;">Mark all as read</a>
                                </li>
                                <li class="notification-li" data-notification-id="91">
                                    <!-- list item-->
                                    <!-- list item-->
                                    <a href="" class="n-top n-link list-group-item ">
                                        <div class="n-box media-box ">
                                            <div class="pull-left">
                                                <img src="https://raw.githubusercontent.com/encharm/Font-Awesome-SVG-PNG/master/black/png/128/suitcase.png" alt="Avatar" width="40" height="40" class="img-thumbnail img-circle n-image">
                                            </div>
                                            <div class="media-box-body clearfix">
                                                <span class="n-title text-sm block">A new Training By Android Apps Development has been assigned to you</span> <small class="text-muted pull-left" style="margin-top: -4px"><i class="fa fa-clock-o"></i> 2 years ago</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="{{ \Auth::user()->image }}" class="img-xs user-image" alt="User Image" />
                ...
                <div class="navbar-form">
                    <div class="form-group has-feedback">
                        <div class="input-group">
                            ...
                            <input type="text" id="all_search" placeholder="Search your need ...." class="form-control search-icon">
